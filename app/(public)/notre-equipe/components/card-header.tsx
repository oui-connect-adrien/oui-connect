	...
	return (
		...
		>
			...
			<div className="flex flex-col items-center w-[calc(20mm*1)] md:w-[calc(20mm*1.5)]">
				<div className="relative shrink-0 w-[calc(10mm*1)] h-[calc(10mm*1)] md:w-[calc(10mm*1.5)] md:h-[calc(10mm*1.5)] rounded-full overflow-hidden border-2 border-white/20">
					<Image
						src={company_image}
						alt={company_name}
						width={96}
