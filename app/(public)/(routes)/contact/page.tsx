...
const ContactPage = () => {
	return (
		<div className="[mask-image:linear-gradient(to_top,transparent,white_10%,white_90%,transparent)] relative min-h-screen bg-grid-slate-100/70 pt-4 pb-32 antialiased overflow-hidden">
