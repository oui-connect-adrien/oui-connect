		...
		>
			...
			>
				<CardBody className="group-hover:shadow-2xl rounded-xl md:rounded-2xl h-[calc(54mm)] w-[calc(83mm)] md:h-[calc(54mm*1.5)] md:w-[calc(85mm*1.5)] ">
					<div
						className={`w-full h-full rounded-xl md:rounded-2xl bg-linear-to-br ${member.colors.from} ${member.colors.to} shadow-2xl  border border-white/10 overflow-hidden`}
					>
						{/* Grid Background */}
						<div className="absolute inset-0 opacity-[0.07] bg-size-[30px_30px] bg-[linear-gradient(to_right,white_1px,transparent_1px),linear-gradient(to_bottom,white_1px,transparent_1px)]" />
						{/* Radial Gradient Overlay */}
						<div className="pointer-events-none inset-0 bg-linear-to-br from-transparent to-black/20" />
						...
						<div className=" inset-0 p-[calc(4mm*1)] md:p-[calc(4mm*1.5)]">
							...
							>
								<div className="h-1 w-full bg-linear-to-r from-white/0 via-white/20 to-white/0" />
							</CardItem>
						</div>
					</div>
				</CardBody>
