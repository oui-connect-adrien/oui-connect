...
const Page = () => {
	...
	return (
		<div className="relative border py-4 antialiased overflow-hidden">
			...
			<div className="mask-[linear-gradient(to_top,transparent,white_20%,white_90%,transparent)] [webkit-mask-image:linear-gradient(to_top,transparent,white_20%,white_80%,transparent)] relative min-h-screen bg-grid-slate-100/70 py-4 antialiased overflow-hidden">
